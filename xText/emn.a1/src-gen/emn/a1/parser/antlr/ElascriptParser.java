...
public class ElascriptParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected emn.a1.parser.antlr.internal.InternalElascriptParser createParser(XtextTokenStream stream) {
		return new emn.a1.parser.antlr.internal.InternalElascriptParser(stream, getGrammarAccess());
	}
